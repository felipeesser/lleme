...
public abstract class PropertyPOA extends org.omg.PortableServer.Servant
		...
		exemploAula.corbaClasses.PropertyOperations {
	...
	public exemploAula.corbaClasses.Property _this() {
		return exemploAula.corbaClasses.PropertyHelper.narrow(_this_object());
	}

	public exemploAula.corbaClasses.Property _this(org.omg.CORBA.ORB orb) {
		return exemploAula.corbaClasses.PropertyHelper
