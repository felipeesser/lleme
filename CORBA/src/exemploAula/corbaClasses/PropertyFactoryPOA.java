...
public abstract class PropertyFactoryPOA extends org.omg.PortableServer.Servant
		...
		exemploAula.corbaClasses.PropertyFactoryOperations {
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String method,
		...
		case 0: // getAll
		{
			...
			exemploAula.corbaClasses.PropertySeqHelper.write(_out, getAll());
			break;
		}
		case 1: // get
		{
			...
			_out = handler.createReply();
			exemploAula.corbaClasses.PropertyHelper.write(_out, get(_arg0));
			break;
		}
		case 2: // create
		{
			try {
				...
				_out = handler.createReply();
				exemploAula.corbaClasses.PropertyHelper.write(_out, create(
						_arg0, _arg1));
			} catch (exemploAula.corbaClasses.PropertyAlreadyExists _ex0) {
				_out = handler.createExceptionReply();
				exemploAula.corbaClasses.PropertyAlreadyExistsHelper.write(
						_out, _ex0);
			}
			break;
		}
		case 3: // destroy
		{
			try {
				...
				_out = handler.createReply();
				destroy(_arg0);
			} catch (exemploAula.corbaClasses.UnknownProperty _ex0) {
				_out = handler.createExceptionReply();
				exemploAula.corbaClasses.UnknownPropertyHelper
						.write(_out, _ex0);
			}
			break;
		}
