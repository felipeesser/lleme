...
public class _PropertyFactoryStub extends org.omg.CORBA.portable.ObjectImpl
		implements exemploAula.corbaClasses.PropertyFactory {
	/**
	 * 
	 */
	...
	public final static java.lang.Class _opsClass = exemploAula.corbaClasses.PropertyFactoryOperations.class;
			...
			if (!this._is_local()) {
				...
				try {
					org.omg.CORBA.portable.OutputStream _os = _request(
							"getAll", true);
					_is = _invoke(_os);
					exemploAula.corbaClasses.Property[] _result = exemploAula.corbaClasses.PropertySeqHelper
							.read(_is);
					return _result;
		...
		while (true) {
			if (!this._is_local()) {
				...
				try {
					...
					_is = _invoke(_os);
					exemploAula.corbaClasses.Property _result = exemploAula.corbaClasses.PropertyHelper
							.read(_is);
					return _result;
				} catch (org.omg.CORBA.portable.RemarshalException _rx) {
				} catch (org.omg.CORBA.portable.ApplicationException _ax) {
			...
			if (!this._is_local()) {
				...
				try {
					...
					if (_id
						...
						throw exemploAula.corbaClasses.PropertyAlreadyExistsHelper
			...
			if (!this._is_local()) {
				...
				try {
					...
					if (_id
						...
						throw exemploAula.corbaClasses.UnknownPropertyHelper
								.read(_ax.getInputStream());
					}
					throw new RuntimeException("Unexpected exception " + _id);
				} finally {
