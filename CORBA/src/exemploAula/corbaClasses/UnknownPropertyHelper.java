...
public final class UnknownPropertyHelper {
	...
	public static org.omg.CORBA.TypeCode type() {
		if (_type == null) {
			_type = org.omg.CORBA.ORB
					.init()
					.create_exception_tc(
							exemploAula.corbaClasses.UnknownPropertyHelper.id(),
							"UnknownProperty",
	...
	public static void insert(final org.omg.CORBA.Any any,
			final exemploAula.corbaClasses.UnknownProperty s) {
		any.type(type());
		write(any.create_output_stream(), s);
	}

	public static exemploAula.corbaClasses.UnknownProperty extract(
	...
	public static exemploAula.corbaClasses.UnknownProperty read(
			final org.omg.CORBA.portable.InputStream in) {
		exemploAula.corbaClasses.UnknownProperty result = new exemploAula.corbaClasses.UnknownProperty();
