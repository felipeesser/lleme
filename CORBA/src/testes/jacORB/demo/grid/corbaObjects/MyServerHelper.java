...
public final class MyServerHelper {
	public static void insert(final org.omg.CORBA.Any any,
			final testes.jacORB.demo.grid.corbaObjects.MyServer s) {
		any.insert_Object(s);
	}

	public static testes.jacORB.demo.grid.corbaObjects.MyServer extract(
	...
	public static testes.jacORB.demo.grid.corbaObjects.MyServer narrow(
			final java.lang.Object obj) {
		if (obj instanceof testes.jacORB.demo.grid.corbaObjects.MyServer) {
			return (testes.jacORB.demo.grid.corbaObjects.MyServer) obj;
	...
	public static testes.jacORB.demo.grid.corbaObjects.MyServer narrow(
		...
		try {
			...
			if (obj
				...
				testes.jacORB.demo.grid.corbaObjects._MyServerStub stub;
				stub = new testes.jacORB.demo.grid.corbaObjects._MyServerStub();
	...
	public static testes.jacORB.demo.grid.corbaObjects.MyServer unchecked_narrow(
			final org.omg.CORBA.Object obj) {
		if (obj == null)
			return null;
		try {
