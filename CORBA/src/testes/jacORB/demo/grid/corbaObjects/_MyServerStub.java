...
public class _MyServerStub extends org.omg.CORBA.portable.ObjectImpl implements
		testes.jacORB.demo.grid.corbaObjects.MyServer {
	/**
	 * 
	 */
	...
	public final static java.lang.Class _opsClass = testes.jacORB.demo.grid.corbaObjects.MyServerOperations.class;
	...
	public short opWithException()
			throws testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException {
		while (true) {
			if (!this._is_local()) {
				org.omg.CORBA.portable.InputStream _is = null;
				try {
					...
					if (_id
						...
						throw testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyExceptionHelper
		...
		while (true) {
			if (!this._is_local()) {
				...
				try {
					...
					_os.write_short(m);
					_is = _invoke(_os);
					java.math.BigDecimal _result = testes.jacORB.demo.grid.corbaObjects.MyServerPackage.fixedTHelper
							.read(_is);
					return _result;
				} catch (org.omg.CORBA.portable.RemarshalException _rx) {
				} catch (org.omg.CORBA.portable.ApplicationException _ax) {
