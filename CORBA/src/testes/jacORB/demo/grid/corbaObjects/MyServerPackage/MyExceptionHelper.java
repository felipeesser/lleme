...
public final class MyExceptionHelper {
	...
	public static void insert(
			...
			final testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException s) {
		any.type(type());
		write(any.create_output_stream(), s);
	}

	public static testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException extract(
			final org.omg.CORBA.Any any) {
	...
	public static testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException read(
			final org.omg.CORBA.portable.InputStream in) {
		testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException result = new testes.jacORB.demo.grid.corbaObjects.MyServerPackage.MyException();
