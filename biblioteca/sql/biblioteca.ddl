...
ALTER TABLE Devolucao ADD CONSTRAINT FK_Emprestimo_Devolucao FOREIGN KEY ( numero ) REFERENCES Emprestimo ( operacao_numero ) ;

ALTER TABLE Emprestimo ADD CONSTRAINT FK_Exemplar_Emprestimo FOREIGN KEY ( codigo, num ) REFERENCES Exemplar ( codigo, num ) ;

ALTER TABLE Reserva ADD CONSTRAINT FK_Livro_Reserva FOREIGN KEY ( Livro_material_codigo ) REFERENCES Livro ( material_codigo ) ;

ALTER TABLE Exemplar ADD CONSTRAINT FK_Material_Exemplar FOREIGN KEY ( codigo ) REFERENCES Material ( codigo ) ;

ALTER TABLE Usuario ADD CONSTRAINT FK_Tipo_Usuario FOREIGN KEY ( tipo_codigo ) REFERENCES Tipo ( codigo ) ;

ALTER TABLE Login ADD CONSTRAINT FK_Usuario_Login FOREIGN KEY ( usuario_id ) REFERENCES Usuario ( id ) ;

ALTER TABLE Operacao ADD CONSTRAINT FK_Usuario_Operacao FOREIGN KEY ( usuario_id ) REFERENCES Usuario ( id ) ;
