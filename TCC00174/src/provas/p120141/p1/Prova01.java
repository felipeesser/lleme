package provas.p120141.p1;

import java.util.Scanner;
import provas.p120141.mtx.Matriz;
import provas.p120141.mtx.MatrizDensa;
import provas.p120141.mtx.MatrizIdentidade;
    ...
    private static void imprimir(Matriz m1) {
        for (int i = 0; i < m1.numeroDeLinhas(); i++) {
            for (int j = 0; j < m1.numeroDeColunas(); j++)
                System.out.println(m1.obter(i, j) + "\t");
            System.out.println("\n");
        }
    }
