 ...
 * TCC-00174
 * Aula 3 - Entrada e Saída com Arquivos, Exercícios.
 * Classe Serialização de Alunos
 * 
...
public class SerializacaoAlunos {
    /**
     * Programa que ilustra como serializar objetos de uma classe.
     * No exemplo o objeto é uma classe que encapsula uma lista de alunos
     * implementada como um array. A serialização salva e permite recuperar
     * toda a lista como um objeto único.
     *
     * Um teste interessante é tornar o array de alunos transiente na classe
     * Alunos e fazer Aluno não ser serializavel. O resultado é que o objeto
     * da classe Alunos é recuperado, contudo o array de alunos não é.
     * 
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            // Destroi os objetos
            alunos = null; aluno1 = null;
            aluno2 = null; aluno3 = null;
