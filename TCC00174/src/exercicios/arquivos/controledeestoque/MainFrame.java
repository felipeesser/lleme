...
/**
 * Programa que simula um controle de produtos em um estoque.
 * E possível abrir um arquivo binário e acessar os registros diretamente
 * na interface clicando no menu cadastrar.
 * A setas permitem navegar pelos registros. Os botões cadastrar e
 * deletar inserem e removem registros diretamente no arquivo.
 * Os registros não são armazenados em memória exceto o que é carregado
 * para exibição.
 * @author Anselmo
 */
