...
public class PasseioDoCavalo extends Backtracking {
    ...
    private Posicao posicaoPorID(int pos, Posicao p) {
        switch(pos){
            case 0: return new Posicao( p.getI()+1, p.getJ()+2 );
            case 1: return new Posicao( p.getI()+1, p.getJ()-2 );
            case 2: return new Posicao( p.getI()-1, p.getJ()+2 );
            case 3: return new Posicao( p.getI()-1, p.getJ()-2 );
            case 4: return new Posicao( p.getI()+2, p.getJ()+1 );
            case 5: return new Posicao( p.getI()+2, p.getJ()-1 );
            case 6: return new Posicao( p.getI()-2, p.getJ()+1 );
            case 7: return new Posicao( p.getI()-2, p.getJ()-1 );
        }
