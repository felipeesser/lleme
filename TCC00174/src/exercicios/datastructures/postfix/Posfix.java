...
public class Posfix{
    public static void main(String[] args) {
        ...
        while ( scan.hasNext() ) {
            String s = scan.next();
            if      (s.equals("+")) stack.push( (Integer)stack.topAndPop() + (Integer)stack.topAndPop());
            else if (s.equals("-")) stack.push( (Integer)stack.topAndPop() - (Integer)stack.topAndPop());
            else if (s.equals("*")) stack.push( (Integer)stack.topAndPop() * (Integer)stack.topAndPop());
            else if (s.equals("/")) stack.push( (Integer)stack.topAndPop() / (Integer)stack.topAndPop());
            else if(!s.equals(" ")) stack.push(Integer.parseInt( s ));
        }
